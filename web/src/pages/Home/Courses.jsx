...
const data = [
	{
		...
		fee: 2323,
		summary: `PHP Setup, Git Setup, Basic Programming with PHP`,
	}, {
		name: "Express JS- for beginers",
		image: "express.png",
		duration: "1 Month (20 sessions)",
		category: "web-development",
		requisite: ["Basic HTML", "Basic Javascript", "Basic CSS"],
		mode: "Instructor lead class",
		fee: 5000,
		summary: `Setting up Expressjs Project, Understanding Project Flow, Setting up Database (MongoDB), Basic Crud based applications`,
	}, {
		name: "Next JS- for beginers",
		image: "next.png",
		duration: "1 Month (20 sessions)",
		category: "web-development",
		requisite: ["Basic HTML", "Basic Javascript", "Basic CSS"],
		mode: "Instructor lead class",
		fee: 5000,
		summary: `Setting up NextJS Project, Understanding Project Flow,  Setting up Database (MongoDB), Basic Crud based applications`,
	}
];
